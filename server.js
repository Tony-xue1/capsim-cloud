...
> 💡 投入策略：本轮主要投入前 4 项（CPI/Vendor/QIT/Channel），每项 $500K-$1,000K。后续轮次逐步扩展。
` : `> ⚠️ TQM 模块第 3 轮起才解锁，本轮（第 ${cr} 轮报告→第 ${nr} 轮决策）暂不可用。`}

### 3.6 HR 决策

#### 招聘 / 离职推算
- 查看 Courier 报告中 **HR/TQM 页面** 的 **"Needed Complement"**（所需员工数）
- 对比当前 **Complement**，差值即为本轮需招人或裁人的数量
- 招聘需提前 1 轮，新员工下轮才能上岗
- 离职率与工资水平负相关（低于行业平均→离职率高）
...
| 招聘投入($K) | | | | | |
| 培训时长(hrs) | | | | | |
| 工资水平(%) | 行业≈100% | 行业≈100% | 行业≈100% | 行业≈100% | 行业≈100% |

**HR 决策指南**：
- **培训**：每年 20-40 小时，降低次品率、提升效率、降低劳动力成本
- **工资**：行业平均 100%，略高 102-105% 降低离职率，不建议低于 95%
- **招聘投入**：根据需补员工数量配置，每人约 $1K-$3K
- **效益评估**：高培训+适中工资 → 长期劳动力成本最低化
- **产能匹配**：员工数必须匹配产量需求，产能扩张需同步招人
`;
}
